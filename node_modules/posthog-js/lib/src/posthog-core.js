...
var defaultsThatVaryByConfig = function (defaults) { return ({
    ...
    session_recording: defaults && defaults >= '2026-05-30'
...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_j = this.logs) === null || _j === void 0 ? void 0 : _j.reset();
        (_k = this.persistence) === null || _k === void 0 ? void 0 : _k.set_property(constants_1.USER_STATE, constants_1.USER_STATE_ANONYMOUS);
        (_l = this.sessionManager) === null || _l === void 0 ? void 0 : _l.resetSessionId();
        this._cachedPersonProperties = null;
